...
class UpyunStorage(Storage):
    def __init__(self, bucket=settings.UPYUN_BUCKET, username=settings.UPYUN_USER, password=settings.UPYUN_PASS,
                 timeout=30, endpoint=upyun.ED_AUTO):
        self.upyun = upyun.UpYun(bucket=bucket, username=username, password=password,
