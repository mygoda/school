...
class WeixinUserTokenAdmin(admin.ModelAdmin):
    list_display = ['user', "openid", "access_token", "refresh_token", "scope", "expires_in", "created_at"]
    raw_id_fields = ['user']
...
admin.site.register(WeixinUserToken, WeixinUserTokenAdmin)