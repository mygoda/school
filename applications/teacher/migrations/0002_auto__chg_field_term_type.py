...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Term.type'
        db.alter_column(u'teacher_term_tpl', 'type', self.gf('django.db.models.fields.SmallIntegerField')(max_length=128))

    def backwards(self, orm):

        # Changing field 'Term.type'
        db.alter_column(u'teacher_term_tpl', 'type', self.gf('django.db.models.fields.CharField')(max_length=128))
